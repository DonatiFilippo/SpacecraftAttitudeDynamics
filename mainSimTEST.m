...
flag.gg = 0; % Set to 1 to use gravity gradient perturbation
flag.srp = 0; % Set to 1 to consider srp perturbation
flag.mag = 0; % Set to 1 to consider magnetic field perturbation
